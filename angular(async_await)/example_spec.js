...
describe('angularjs page', function() {
   it('should open page with example from box GetAGlimpseOfAngular', async function() {
     ...
     await browser.getAllWindowHandles().then(async function (handles) {
        ...
        expect(await browser.getCurrentUrl()).toBe('https://stackblitz.com/angular/xovobqmrnyn');
     });
  ...
  it('should open Architecture overview page from box Fundamentals', async function() {
...
describe('result of search', function() {
  ...
  it('should find MockBackend and redirect to the page', async function() {
        await pageObject.search.click();
